...
mod tests {
    ...
    fn response_matches_shared_known_answer() {
        ...
        assert_eq!(
            encoded,
            [
                0x48, 0x4c, 0x02, 0x03, 0x2e, 0x09, 0x02, 0x48, 0x4c, 0x00, 0x00, 0x01, 0x6d, 0x61,
                0x67, 0x6e, 0x65, 0x74, 0x6f, 0x65, 0x6c, 0x61, 0x73, 0x74, 0x69, 0x63, 0x00, 0x00,
    ...
    fn malformed_responses_are_rejected() {
        ...
        let mut encoded = [0; RESPONSE_LEN];
        BeaconResponse::new([0; 6], "magnetoelastic", "test").encode(&mut encoded);
        encoded[0] = 0;
