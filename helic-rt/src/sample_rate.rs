//! Supported crystal-exact real-time sample-rate presets.
...
mod tests {
    ...
    #[test]
    fn presets_have_consistent_periods_and_steps() {
        for rate in [
            SampleRate::Hz1000,
            SampleRate::Hz2000,
            SampleRate::Hz4000,
            ...
            assert_eq!(rate.dt(), 1.0 / rate.hz());
            assert_eq!(rate.period_us() as f32, 1_000_000.0 / rate.hz());
        }
    }
}
